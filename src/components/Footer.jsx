    ...
    <footer className="footer">
      <div className="footer-container">
        <div className="footer-main">
          <div className="footer-left">
            <div className="footer-logo">
              <svg className="logo-ltm-svg" xmlns="http://www.w3.org/2000/svg" width="64" height="16" viewBox="0 0 64 16" fill="none">
            ...
            <h2 className="footer-tagline">It's time to Outcreate</h2>
          ...
          <div className="footer-links">
            <a href="#">CME Live</a>
            <a href="#">Mission:AIPossible</a>
            <a href="#">AI Exchange</a>
          </div>
        </div>
        ...
        <div className="footer-bottom">
          <span className="footer-copyright">Copyright© 2026 CAVE. All Rights Reserved.</span>
          <span className="footer-legal">User Terms & Conditions | Privacy Policy</span>
        </div>
      </div>
    </footer>
  )
